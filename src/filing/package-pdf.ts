...
const COPY: Record<Language, PackageCopy> = {
  en: {
    title: "RTI draft",
    subtitle: "Filing demo - nothing is sent to a government system",
    confirmedNeed: "Your question",
    canonicalNeed: "RTI request",
    measure: "Information requested",
    geography: "Area",
    period: "Time period",
    breakdown: "Breakdown needed",
    informationHolder: "Government authority",
    resolutionPreference: "What would work for you?",
    unresolvedClarifications: "Unresolved clarifications",
    filingDraft: "RTI request",
    filingRoute: "RTI channel",
    holder: "Government authority",
    route: "RTI channel name",
    officialLink: "Official service",
    routeNotVerified: "Official service not verified in this prototype",
    verified: "Verified",
    ...
    registration: "Demo reference",
    fictionalTime: "Demo time",
    disclosure: "Submission disclosure",
    submissionDisclosure:
      "This is a filing demo. A real government website would provide its own acknowledgement and response information.",
    boundary:
  ...
  hi: {
    title: "RTI ड्राफ्ट",
    subtitle: "फाइलिंग डेमो - किसी सरकारी सिस्टम को कुछ नहीं भेजा जाता",
    confirmedNeed: "आपका सवाल",
    canonicalNeed: "RTI अनुरोध",
    measure: "माँगी गई जानकारी",
    geography: "क्षेत्र",
    period: "समय अवधि",
    breakdown: "कौन-सा विभाजन चाहिए",
    informationHolder: "सरकारी प्राधिकरण",
    resolutionPreference: "आपके लिए क्या ठीक रहेगा?",
    unresolvedClarifications: "अनसुलझे स्पष्टीकरण",
    filingDraft: "RTI अनुरोध",
    filingRoute: "RTI चैनल",
    holder: "सरकारी प्राधिकरण",
    route: "RTI चैनल का नाम",
    officialLink: "आधिकारिक सेवा",
    routeNotVerified: "इस प्रोटोटाइप में आधिकारिक सेवा सत्यापित नहीं है",
    verified: "सत्यापन",
    profile: "आवेदक का विवरण",
    name: "नाम",
    email: "ईमेल",
    address: "पता",
    state: "राज्य",
    ...
    registration: "डेमो संदर्भ",
    fictionalTime: "डेमो समय",
    disclosure: "सबमिशन प्रकटीकरण",
    submissionDisclosure:
      "यह फाइलिंग डेमो है। असली सरकारी वेबसाइट अपनी पावती और प्रतिक्रिया की जानकारी देगी।",
    boundary:
