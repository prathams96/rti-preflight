...
export const RESULT_STAGE_COPY = {
  ...
  hi: {
    ...
    draftTitle: "अपने RTI Filing Draft की समीक्षा करें",
    draftIntro:
      "यह बदलाव योग्य Filing Draft है। यह RTI फाइलिंग नहीं है और किसी सरकारी सिस्टम को नहीं भेजा गया है।",
    fileStage: "फाइलिंग डेमो",
    fileTitle: "RTI फाइलिंग डेमो आज़माएँ",
    fileIntro:
      "यह फाइलिंग की simulated journey है। किसी सरकारी सिस्टम को कुछ नहीं भेजा जाता और इस डेमो से RTI दाखिल नहीं होती।",
