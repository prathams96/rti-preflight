...
| #25 Public certification             | `docs/release/release-checklist.md` and `docs/release/demo-runbook.md` define the evidence to collect.                                                                                                                                                                                          | Blocked on public deployment access and smoke-test evidence                                             |
